...
Polymer({
  _template: html`
    <div class="outline">
      ...
      <px-vis-threshold svg="[[svg]]" complete-series-config="[[completeSeriesConfig]]" threshold-data="[[thresholdData]]" y="[[y]]" domain-changed="[[domainChanged]]" threshold-config="[[thresholdConfig]]" width="[[width]]" margin="[[margin]]">
      </px-vis-threshold>
      </div>
`,
