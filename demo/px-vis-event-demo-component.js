...
Polymer({
  _template: html`
    <div class="outline">
      ...
      <px-vis-event svg="[[svg]]" x-axis-type="time" event-data="[[eventData]]" height="[[height]]" margin="[[margin]]" x="[[x]]" y="[[y]]" event-config="[[eventConfig]]" domain-changed="[[domainChanged]]">
      </px-vis-event>

    </div>
`,

  is: "px-vis-event-demo-component",
