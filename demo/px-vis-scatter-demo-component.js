...
Polymer({
  _template: html`
      <div class="outline">
        ...
        <px-vis-scatter svg="[[svg]]" series-id="mySeries" complete-series-config="[[completeSeriesConfig]]" chart-data="[[chartData]]" x="[[x]]" y="[[y]]" marker-symbol="bar" domain-changed="[[domainChanged]]">
        </px-vis-scatter>

      </div>
`,

  is: "px-vis-scatter-demo-component",
