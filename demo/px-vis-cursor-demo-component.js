...
Polymer({
  _template: html`
      <div class="outline">
        ...
        <px-vis-interaction-space x-axis-type="time" svg="[[svg]]" width="[[width]]" height="[[height]]" margin="[[margin]]" complete-series-config="[[completeSeriesConfig]]" chart-data="[[chartData]]" tooltip-data="{{tooltipData}}" series-keys="[[seriesKeys]]" extents-data="{{extentsData}}" x="[[x]]" y="[[y]]" domain-changed="[[domainChanged]]" time-data="x">
        </px-vis-interaction-space>
        <px-vis-cursor svg="[[svg]]" width="[[width]]" height="[[height]]" margin="[[margin]]" complete-series-config="[[completeSeriesConfig]]" chart-data="[[chartData]]" tooltip-data="[[tooltipData]]" selection-type="[[selectionType]]" series-keys="[[seriesKeys]]">
        </px-vis-cursor>
        <px-vis-line-svg svg="[[svg]]" series-id="mySeries" complete-series-config="[[completeSeriesConfig]]" chart-data="[[chartData]]" x="[[x]]" y="[[y]]" domain-changed="[[domainChanged]]">
        </px-vis-line-svg>
      </div>
`,
