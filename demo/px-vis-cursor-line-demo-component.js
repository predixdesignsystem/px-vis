...
Polymer({
  _template: html`
    ...
    <px-vis-cursor-line id="lineCursor" x="[[x]]" y="[[y]]" parallel-coordinates="" dimensions="[[dimensions]]" domain-changed="[[domainChanged]]" time-data="x" complete-series-config="[[completeSeriesConfig]]" series-id="x" tooltip-data="[[tooltipData.dataset]]">
    </px-vis-cursor-line>
`,
