...
Polymer({
  _template: html`
    <px-vis-brush svg="[[svg]]" axis="[[x]]" height="[[height]]" width="[[width]]" margin="[[margin]]" domain-changed="[[domainChanged]]">
    </px-vis-brush>
    <px-vis-svg class="inline--flex flex__item--msfix" width="[[width]]" height="[[height]]" margin="[[margin]]" svg="{{svg}}">
    </px-vis-svg>
