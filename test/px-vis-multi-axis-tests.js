...
function runTests(){
  ...
  suite('px-vis-multi-axis basic setup works', function() {
    ...
    test('multiAxis first axis ticks are correct', function() {
      var ticks = Px.d3.select(multiAxis.axisGroups.nodes()[0]).selectAll('g.tick').nodes();
    ...
    test('multiAxis second axis ticks correct', function() {
      var ticks = Px.d3.select(multiAxis.axisGroups.nodes()[1]).selectAll('g.tick').nodes();
    ...
    test('multiAxis third axis ticks correct', function() {
      var ticks = Px.d3.select(multiAxis.axisGroups.nodes()[2]).selectAll('g.tick').nodes();
  ...
  suite('px-vis-multi-axis add a dimension', function() {
    ...
    test('multiAxis fourth axis ticks correct', function() {
      var ticks = Px.d3.select(multiAxis.axisGroups.nodes()[3]).selectAll('g.tick').nodes();
  ...
  suite('px-vis-multi-axis no match ticks setup works', function() {
    ...
    test('noMatchAxis created three groups', function() {
      assert.equal(noMatchAxis.axisGroups.nodes().length, 3);
    });

    test('noMatchAxis each group is transformed correctly', function() {
      var re = /translate\((\d+)\s?,?\d*\)/,
          gs = noMatchAxis.axisGroups.nodes(),
          g0 = re.exec(Px.d3.select(gs[0]).attr('transform')),
          g1 = re.exec(Px.d3.select(gs[1]).attr('transform')),
          g2 = re.exec(Px.d3.select(gs[2]).attr('transform'));
    ...
    test('noMatchAxis first axis ticks correct', function() {
      var ticks = Px.d3.select(noMatchAxis.axisGroups.nodes()[0]).selectAll('g.tick').nodes();
    ...
    test('noMatchAxis second axis ticks correct', function() {
      var ticks = Px.d3.select(noMatchAxis.axisGroups.nodes()[1]).selectAll('g.tick').nodes();
    ...
    test('noMatchAxis third axis ticks correct', function() {
      var ticks = Px.d3.select(noMatchAxis.axisGroups.nodes()[2]).selectAll('g.tick').nodes();
  ...
  suite('px-vis-multi-axis radial setup works', function() {
    ...
    test('radialAxis created three groups', function() {
      assert.lengthOf(radialAxis.axisGroups.nodes(), 3);
    });
    ...
    test('radialAxis created three groups', function() {
      assert.equal(radialAxis.axisGroups.nodes().length, 3);
    });

    test('radialAxis each group is transformed correctly', function() {
      var re = /rotate\((\d+)\)/,
          gs = radialAxis.axisGroups.nodes(),
          g0 = re.exec(Px.d3.select(gs[0]).attr('transform')),
          g1 = re.exec(Px.d3.select(gs[1]).attr('transform')),
          g2 = re.exec(Px.d3.select(gs[2]).attr('transform'));
    ...
    test('radialAxis first axis ticks are correct', function() {
      var ticks = Px.d3.select(radialAxis.axisGroups.nodes()[0]).selectAll('g.tick').nodes();
    ...
    test('radialAxis second axis ticks are removed', function() {
      var ticks = Px.d3.select(radialAxis.axisGroups.nodes()[1]).selectAll('g.tick').nodes();

      assert.lengthOf(ticks,0);
    });

    test('radialAxis third axis ticks are removed', function() {
      var ticks = Px.d3.select(radialAxis.axisGroups.nodes()[2]).selectAll('g.tick').nodes();
  ...
  suite('px-vis-multi-axis radial add a dimension', function() {
    ...
    test('radialAxis created three groups', function() {
      assert.equal(radialAxis.axisGroups.nodes().length, 4);
    });
    ...
    test('radialAxis fourth axis ticks are removed', function() {
      var ticks = Px.d3.select(radialAxis.axisGroups.nodes()[3]).selectAll('g.tick').nodes();
