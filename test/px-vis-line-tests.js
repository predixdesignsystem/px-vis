...
function runTests(){
  ...
  suite('px-vis-line works', function() {
    ...
    test('baseLine line d', function() {
      assert.equal(baseLine.linePath.attr('d').split(' ').join(','),"M0,91.8L71.7627200385821,104.39999999999998L144.56715698095007,95.40000000000002L242.25705329153604,68.39999999999999L281.2635640221847,73.8L364.2536773571256,90.00000000000001L480,0");
    });
  }); //suite
  ...
  suite('px-vis-line with two series works', function() {
    ...
    test('mutedLine1 line d', function() {
      assert.equal(mutedLine1.linePath.attr('d').split(' ').join(','),"M0,180.89999999999998L71.7627200385821,187.20000000000002L144.56715698095007,182.70000000000002L242.25705329153604,169.20000000000002L281.2635640221847,171.9L364.2536773571256,180.00000000000003L480,135");
    });
    ...
    test('mutedLine2 line d', function() {
      assert.equal(mutedLine2.linePath.attr('d').split(' ').join(','),"M0,90.00000000000001L71.7627200385821,0L144.56715698095007,180.00000000000003L242.25705329153604,90.00000000000001L281.2635640221847,90.00000000000001L364.2536773571256,180.00000000000003L480,180.00000000000003");
    });
  }); //suite
